...
namespace Microsoft.AspNetCore.Cryptography.KeyDerivation
{
    public class Pbkdf2Tests
    {
        ...
        public void RunTest_Normal_Default(string password, KeyDerivationPrf prf, int iterationCount, int numBytesRequested, string expectedValueAsBase64)
        {
            // Arrange
            ...
            // Act & assert
            TestProvider<DefaultPbkdf2Provider>(password, salt, prf, iterationCount, numBytesRequested, expectedValueAsBase64);
        }

        [Fact]
        public void RunTest_WithLongPassword_Default_FallbackToManaged()
        {
            ...
            RunTest_WithLongPassword_Impl<DefaultPbkdf2Provider>(salt, expectedDerivedKeyBase64);
        }

        [Fact]
        public void RunTest_WithLongPassword_Default()
        {
            // salt longer than 8 bytes
            var salt = Encoding.UTF8.GetBytes("abcdefghijkl");
            RunTest_WithLongPassword_Impl<DefaultPbkdf2Provider>(salt, "NGJtFzYUaaSxu+3ZsMeZO5d/qPJDUYW4caLkFlaY0cLSYdh1PN4+nHUVp4pUUubJWu3UeXNMnHKNDfnn8GMfnDVrAGTv1lldszsvUJ0JQ6p4+daQEYBc//Tj/ejuB3luwW0IinyE7U/ViOQKbfi5pCZFMQ0FFx9I+eXRlyT+I74=");
        }
#else
